  ...
  },
  {
    ...
    pages: [
      ...
      },
      {
        ...
        route: '/calls',
        pageKey: 'voice-calls',
        components: ['CallsLayout', 'CallsOverview', 'CallsLog', 'CallsAssistant', 'CallsNumbers', 'CallsAutomations', 'CallsSettings'],
        apis: [
          '/api/voice/calls',
          '/api/voice/calls/stats',
          '/api/voice/numbers',
          '/api/voice/handoffs/recent',
          '/api/voice/settings',
          '/api/webhooks/telnyx/voice',
        ],
        services: ['VoiceCallController', 'VoiceNumberController', 'VoiceHandoffController', 'VoiceSettingsController', 'TelnyxVoiceWebhookController'],
        externals: ['Telnyx'],
      },
      {
  ...
  },
  {
    ...
    pages: [
      ...
      },
      {
        ...
        apis: ['/api/cubicasa/shoots', '/api/integrations/shoots/{shoot}/cubicasa/order'],
        services: ['CubiCasaShootTrackerController', 'IntegrationController'],
        externals: ['CubiCasa'],
      },
    ],
  },
