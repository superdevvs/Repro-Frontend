  ...
  },
  {
    ...
    pages: [
      ...
      },
      {
        ...
        apis: ['/api/admin/invoices', '/api/client/billing', '/api/payments/create'],
        services: ['InvoiceController', 'ClientBillingController', 'PaymentController'],
        externals: ['Square', 'Stripe'],
      },
    ],
  },
  {
