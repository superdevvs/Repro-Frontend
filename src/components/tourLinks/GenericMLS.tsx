...
import { BedDouble, Bath, Maximize, ChevronLeft, ChevronRight, Link2, ExternalLink, Car, DollarSign, FileText } from "lucide-react";
    ...
    const fetchData = async () => {
      try {
        ...
        if (data?.locked) {
          ...
          if (resolvedShootId) {
            setShootId(Number(resolvedShootId));
          }
          return;
        }
        ...
        const iguideSources = resolvePublicIguideSources(data, 'generic-mls');
        ...
        const safeEmbeds = rawEmbeds.map((value, index) => {
          ...
          return {
            ...
            ...resolvePublicEmbedSources(embed, 'generic-mls'),
          };
    ...
    return (
      <div className="fixed inset-0 flex items-center justify-center bg-background px-6">
        <div className="max-w-md rounded-3xl border border-border bg-card p-8 text-center shadow-sm">
          ...
          <h1 className="text-2xl font-semibold tracking-tight">This tour is locked</h1>
